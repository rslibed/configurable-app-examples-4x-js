...
define(["require", "exports", "esri/core/tsSupport/declareExtendsHelper", "esri/core/tsSupport/decorateHelper", "dojo/i18n!./Share/nls/resources", "esri/core/lang", "esri/core/accessorSupport/decorators", "esri/widgets/Widget", "esri/widgets/support/widget", "./Share/ShareViewModel"], function (require, exports, __extends, __decorate, i18n, lang_1, decorators_1, Widget, widget_1, ShareViewModel) {
    ...
    var Share = /** @class */ (function (_super) {
        ...
        Share.prototype.render = function () {
            var _a = this.viewModel, state = _a.state, shortenState = _a.shortenState, linkGenerated = _a.linkGenerated, shareLocationEnabled = _a.shareLocationEnabled;
            var shareItemNodes = this._renderShareItems();
            var shareItemNode = state === "ready" && shareItemNodes.length ? [shareItemNodes] : null;
            var inputSubheader = linkGenerated ? i18n.clipboard : i18n.generateLink;
            var copyShortenNode = linkGenerated ? (widget_1.tsx("input", { class: CSS.main.mainUrl.urlInput, bind: this, onclick: this._copyUrl, onkeydown: this._copyUrl, type: "text", value: this.shareUrl, afterCreate: widget_1.storeNode, "data-node-ref": "_urlNode", readOnly: true })) : (widget_1.tsx("button", { bind: this, onclick: this._shortenShareUrl, onkeydown: this._shortenShareUrl, class: CSS.main.mainShorten.shortenUrl }, i18n.generateLink));
            var spinnerIconNode = this.shortenLinkEnabled ? (shortenState === "shortening" ? (widget_1.tsx("div", { class: CSS.main.mainShorten.spinner },
                widget_1.tsx("svg", { xmlns: "http://www.w3.org/2000/svg", width: "32", height: "32", viewBox: "0 0 32 32", class: this.classes(CSS.icons.svgIcon, CSS.icons.esriRotatingIcon, CSS.icons.spinnerIcon) },
